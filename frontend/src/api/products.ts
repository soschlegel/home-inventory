...
export const updateProduct = (id: string, data: Partial<{ name: string; description: string; barcode: string; purchaseUrl: string; minQuantity: number | null; tags: string[] }>) =>
